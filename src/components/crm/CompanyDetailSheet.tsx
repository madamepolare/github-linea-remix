...
import { DetailSheet, DetailSection, DetailRow, DetailDivider } from "@/components/ui/patterns";
...
export function CompanyDetailSheet({ company, open, onOpenChange, onEdit }: CompanyDetailSheetProps) {
