...
export const FeatureCard = ({
  ...
  return (
    <div
      ref={cardRef}
      className="feature-card group relative p-8 rounded-2xl bg-card border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-xl hover:shadow-primary/5"
