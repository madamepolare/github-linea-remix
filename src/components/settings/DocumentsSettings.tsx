    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configuration de la numérotation et des informations par défaut
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Numbering settings */}
          <div className="space-y-4">
            <h4 className="font-medium">Numérotation automatique</h4>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  value={defaultSettings.default_sender_name}
                  onChange={(e) => 
                    setDefaultSettings(prev => ({ ...prev, default_sender_name: e.target.value }))
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="email"
                  value={defaultSettings.default_sender_email}
                  onChange={(e) => 
                    setDefaultSettings(prev => ({ ...prev, default_sender_email: e.target.value }))
                  }
              ...
              <div className="space-y-2 col-span-2">
                <Label>Adresse</Label>
                <Textarea
                  value={defaultSettings.default_sender_address}
                  onChange={(e) => 
                    setDefaultSettings(prev => ({ ...prev, default_sender_address: e.target.value }))
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  value={defaultSettings.default_sender_phone}
                  onChange={(e) => 
                    setDefaultSettings(prev => ({ ...prev, default_sender_phone: e.target.value }))
                  }
