...
export function BudgetTimeTab({ projectId }: BudgetTimeTabProps) {
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {filteredSortedEntries.length === 0 ? (
                        ...
                        filteredSortedEntries.map((entry) => {
                          const hrlyRate = getMemberHourlyRate(entry.userId);
                          const cost = (entry.durationMinutes / 60) * hrlyRate;
                    ...
                    <TableFooter>
                      <TableRow>
                        ...
                        <TableCell className="text-right font-semibold">
                          {formatCurrency(filteredTotals.totalClientCost)}
                        </TableCell>
                      </TableRow>
                    </TableFooter>
                  </Table>
