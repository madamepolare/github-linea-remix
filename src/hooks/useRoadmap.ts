...
// Default modules - all in progress for feedback collection
export const DELIVERED_MODULES: Omit<RoadmapItem, 'id' | 'created_at' | 'updated_at'>[] = [
  { workspace_id: null, title: 'Dashboard & Pilotage', description: 'Tableau de bord consolidé avec KPIs temps réel, widgets personnalisables et vue d\'ensemble de l\'activité', category: 'module', status: 'in_progress', priority: 100, release_version: '1.0', release_date: null, quarter: null, icon: 'LayoutDashboard', color: 'blue', module_slug: 'dashboard', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'CRM Intégré', description: 'Gestion complète des entreprises, contacts et leads avec pipeline commercial, historique des échanges et segmentation', category: 'module', status: 'in_progress', priority: 99, release_version: '1.0', release_date: null, quarter: null, icon: 'Building2', color: 'green', module_slug: 'crm', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Gestion de Projets', description: 'Phases, livrables, timeline, vues Board/List/Timeline, budgets et suivi d\'avancement', category: 'module', status: 'in_progress', priority: 98, release_version: '1.0', release_date: null, quarter: null, icon: 'FolderKanban', color: 'purple', module_slug: 'projects', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Tâches & Kanban', description: 'Système complet avec sous-tâches, assignation, priorités, tags, dépendances et vues multiples', category: 'module', status: 'in_progress', priority: 97, release_version: '1.0', release_date: null, quarter: null, icon: 'CheckSquare', color: 'orange', module_slug: 'tasks', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Devis & Commercial', description: 'Quote Builder avancé avec phases, modèles, thèmes PDF personnalisables et échéanciers', category: 'module', status: 'in_progress', priority: 96, release_version: '1.0', release_date: null, quarter: null, icon: 'FileText', color: 'emerald', module_slug: 'commercial', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Appels d\'Offres', description: 'Suivi complet des AO avec analyse DCE, disciplines, synthèse et templates par spécialité', category: 'module', status: 'in_progress', priority: 95, release_version: '1.0', release_date: null, quarter: null, icon: 'FileSearch', color: 'amber', module_slug: 'tenders', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Facturation', description: 'Suivi des factures, échéances, relances et intégration Chorus Pro', category: 'module', status: 'in_progress', priority: 94, release_version: '1.0', release_date: null, quarter: null, icon: 'Receipt', color: 'teal', module_slug: 'invoicing', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Messagerie & Collaboration', description: 'Channels, DMs, fils de discussion par entité, réactions, mentions et GIFs', category: 'module', status: 'in_progress', priority: 93, release_version: '1.0', release_date: null, quarter: null, icon: 'MessageSquare', color: 'indigo', module_slug: 'messages', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Notifications Push', description: 'Notifications temps réel dans l\'app et push navigateur/mobile avec préférences granulaires', category: 'module', status: 'in_progress', priority: 92, release_version: '1.0', release_date: null, quarter: null, icon: 'Bell', color: 'rose', module_slug: 'notifications', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Équipe & RH', description: 'Annuaire, profils, absences, temps de travail, entretiens et gestion de paie', category: 'module', status: 'in_progress', priority: 91, release_version: '1.0', release_date: null, quarter: null, icon: 'Users', color: 'cyan', module_slug: 'team', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Rapports & Analytics', description: 'Analyses financières, projets, temps et RH avec exports et visualisations', category: 'module', status: 'in_progress', priority: 90, release_version: '1.0', release_date: null, quarter: null, icon: 'BarChart3', color: 'violet', module_slug: 'reports', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Chantier & Suivi Travaux', description: 'Planning Gantt multi-lots, comptes-rendus PDF et suivi d\'interventions', category: 'module', status: 'in_progress', priority: 89, release_version: '1.0', release_date: null, quarter: null, icon: 'HardHat', color: 'yellow', module_slug: 'chantier', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Documents', description: 'GED centralisée avec catégories, recherche et liaison aux projets/contacts', category: 'module', status: 'in_progress', priority: 88, release_version: '1.0', release_date: null, quarter: null, icon: 'FileStack', color: 'slate', module_slug: 'documents', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Portail Client', description: 'Accès sécurisé pour clients avec suivi projets, devis et tâches', category: 'module', status: 'in_progress', priority: 87, release_version: '1.0', release_date: null, quarter: null, icon: 'ExternalLink', color: 'sky', module_slug: 'portal', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Bibliothèques', description: 'Matériaux, objets et références réutilisables', category: 'module', status: 'in_progress', priority: 86, release_version: '1.0', release_date: null, quarter: null, icon: 'Library', color: 'stone', module_slug: 'libraries', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Assistant IA Linea', description: 'Requêtes en langage naturel sur vos données via Cmd+K', category: 'feature', status: 'in_progress', priority: 85, release_version: '1.0', release_date: null, quarter: null, icon: 'Sparkles', color: 'fuchsia', module_slug: 'ai', votes_count: 0, is_public: true, created_by: null },
  { workspace_id: null, title: 'Permissions & Rôles', description: 'Système de permissions granulaires par rôle avec overrides workspace', category: 'feature', status: 'in_progress', priority: 84, release_version: '1.0', release_date: null, quarter: null, icon: 'Shield', color: 'red', module_slug: 'permissions', votes_count: 0, is_public: true, created_by: null },
];
