...
export const MODULE_CONFIG: Record<string, ModuleNavConfig> = {
  ...
  crm: {
    ...
    subNav: [
      ...
      { key: "prospection", label: "Prospection IA", href: "/crm/prospection" },
    ],
    quickActions: [
  ...
  team: {
    ...
    subNav: [
      ...
      { key: "leave-balances", label: "Soldes congés", href: "/team/leave-balances" },
      { key: "payroll", label: "Variables paie", href: "/team/payroll" },
