...
export const MODULE_CONFIG: Record<string, ModuleNavConfig> = {
  ...
  team: {
    ...
    isExtension: true,
    subNav: [
      { key: "dashboard", label: "Dashboard", href: "/team/dashboard" },
      { key: "users", label: "Équipe", href: "/team/users" },
      { key: "time", label: "Temps", href: "/team/time-tracking" },
      { key: "absences", label: "Absences", href: "/team/absences" },
      { key: "salaries", label: "Salaires", href: "/team/salaries" },
      { key: "evaluations", label: "Entretiens", href: "/team/evaluations" },
      { key: "payroll", label: "Variables", href: "/team/payroll" },
    ],
    quickActions: [],
  },
  chantier: {
